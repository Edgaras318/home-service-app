...
//             onSettled: (error: unknown) => handleAuthError(error), // Attach global error handler for queries
//         },
//         mutations: {
//             onSettled: (error: unknown) => handleAuthError(error), // Attach global error handler for mutations
//         },
//     },
// });
